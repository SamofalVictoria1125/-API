...
namespace КурсоваяAPI.Controllers
{
    ...
    [ApiController]
    public class Counterparties1Controller : ControllerBase
    {
        private readonly OvoshebazaContext _context;

        public Counterparties1Controller(OvoshebazaContext context)
        {
            _context = context;
        }

        // GET: api/Counterparties1
        [HttpGet]
